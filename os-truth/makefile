...
CC = gcc
LD = ld
LIB = -I lib/ -I lib/kernel/ -I lib/user -I kernel/ -I device/ -I thread/ -I userprog/ -I lib/user
ASFLAGS = -f elf
...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
		...
		$(BUILD_DIR)/process.o $(BUILD_DIR)/syscall.o $(BUILD_DIR)/stdio.o $(BUILD_DIR)/syscall-init.o
...
$(BUILD_DIR)/thread.o: thread/thread.c thread/thread.h \
					...
					kernel/memory.h lib/kernel/print.h kernel/interrupt.h kernel/debug.h lib/kernel/list.h
	$(CC) $(CFLAGS) $< -o $@
...
hd:
	dd if=$(BUILD_DIR)/kernel.bin \
		of=/home/huloves/bochs-2.6.11/hd60M.img \
